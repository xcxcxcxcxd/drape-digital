...
const serviceData: Record<string, ServiceEntry> = {
  ...
  "monthly-seo": {
    ...
    baseStartingPrice: 999,
    schemaPrice: "999",
    packages: [
      { name: "Starter", price: "$999/mo", basePrice: 999, priceSuffix: "/mo", deliverables: ["Technical SEO fixes", "20 backlinks/mo", "2 blog posts/mo", "Monthly report"] },
      { name: "Growth", price: "$1,999/mo", basePrice: 1999, priceSuffix: "/mo", highlight: true, deliverables: ["Everything in Starter", "50 backlinks/mo", "5 blog posts/mo", "Competitor tracking", "Quarterly strategy call"] },
      { name: "Authority", price: "$3,999/mo", basePrice: 3999, priceSuffix: "/mo", deliverables: ["Full SEO management", "100+ backlinks/mo", "Daily monitoring", "Dedicated strategist", "Weekly reporting"] },
    ],
    faqs: [
  ...
  "seo-content": {
    ...
    schemaPrice: "599",
    packages: [
      { name: "Basic", price: "$599", basePrice: 599, deliverables: ["5 SEO articles", "1,500 words each", "Keyword research", "Meta tags included"] },
      { name: "Standard", price: "$1,199", basePrice: 1199, highlight: true, deliverables: ["12 SEO articles", "Up to 2,500 words", "Internal linking", "Images included", "24h turnaround"] },
      { name: "Premium", price: "$2,499", basePrice: 2499, deliverables: ["30 articles/month", "Landing page copy", "Full content calendar", "Topic cluster strategy", "Priority delivery"] },
    ],
    faqs: [
  ...
  "google-maps-citations": {
    ...
    schemaPrice: "299",
    packages: [
      { name: "Basic", price: "$299", basePrice: 299, deliverables: ["5,000 citations", "Tier-1 directories", "NAP consistency check", "Full report"] },
      { name: "Standard", price: "$599", basePrice: 599, highlight: true, deliverables: ["19,000 citations", "Data aggregators", "Duplicate removal", "Google Maps focus", "7-day delivery"] },
      { name: "Premium", price: "$999", basePrice: 999, deliverables: ["95,000 citations", "Full local web coverage", "Niche directories", "Ongoing monitoring", "Priority delivery"] },
    ],
    faqs: [
  ...
  "technical-seo": {
    ...
    schemaPrice: "699",
    packages: [
      { name: "Basic", price: "$699", basePrice: 699, deliverables: ["Full technical audit", "Top 20 priority fixes", "Core Web Vitals report", "Meta optimization"] },
      { name: "Standard", price: "$1,299", basePrice: 1299, highlight: true, deliverables: ["Everything in Basic", "Full implementation", "Schema markup", "Page speed fixes", "Sitemap & robots.txt"] },
      { name: "Premium", price: "$2,499", basePrice: 2499, deliverables: ["Complete on-page overhaul", "Site architecture redesign", "Internal linking rebuild", "Monthly monitoring", "Priority support"] },
    ],
    faqs: [
  ...
  "authority-backlinks": {
    ...
    baseStartingPrice: 799,
    schemaPrice: "799",
    packages: [
      { name: "Basic", price: "$799", basePrice: 799, deliverables: ["10 DR 70+ links", "Manual outreach", "Permanent placement", "Ahrefs report"] },
      { name: "Standard", price: "$1,499", basePrice: 1499, highlight: true, deliverables: ["25 DR 70+ links", "Niche-relevant sites", "Contextual copy", "Indexing service", "Full report"] },
      { name: "Premium", price: "$2,999", basePrice: 2999, deliverables: ["60 DR 70+ links", "DR 80+ target", "Anchor strategy", "Drip delivery", "Priority support"] },
    ],
    faqs: [
  ...
  "guest-posts": {
    ...
    schemaPrice: "499",
    packages: [
      { name: "Basic", price: "$499", basePrice: 499, deliverables: ["2 DA 90+ guest posts", "500-word articles", "1 dofollow link each", "Placement report"] },
      { name: "Standard", price: "$999", basePrice: 999, highlight: true, deliverables: ["5 DA 90+ guest posts", "800-word articles", "Niche matching", "Anchor diversity", "7-day delivery"] },
      { name: "Premium", price: "$1,999", basePrice: 1999, deliverables: ["12 DA 90+ guest posts", "1,500-word articles", "Premium site selection", "Link indexing", "Priority delivery"] },
    ],
    faqs: [
