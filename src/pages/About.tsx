    ...
    <>
      ...
      <section className="py-20 border-t border-agency-white/10 text-lg md:text-2xl font-light leading-relaxed text-agency-white/80">
        <div className="container mx-auto px-6 max-w-4xl space-y-12">
          ...
          <p>
            At Drape Digital, we believe the best way to sell our capability is to prove it. We research your market, we design an incredible digital experience, and we build it out fully.
          </p>
          <p>
